      ...
      <section className="pt-32 pb-16 px-6 lg:px-12">
        <div className="max-w-[1400px] mx-auto">
          <div className="space-y-6">
            <div className="font-black text-sm tracking-[0.3em] text-[#00D9FF] uppercase">
              — News
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-14 pr-6 py-4 bg-white/5 border border-white/10 rounded-xl font-bold text-white placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-[#00D9FF] focus:border-transparent transition-all duration-200"
              />
            </div>
            ...
            <div className="sm:w-72 relative" ref={teamDropdownRef}>
              <div className="relative">
                <input
                  ...
                  className="w-full px-6 py-4 bg-white/5 border border-white/10 rounded-xl font-bold text-white placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-[#00D9FF] focus:border-transparent transition-all duration-200 pr-12"
                />
                <ChevronDown
                  size={20}
      ...
      <section className="pb-24 px-6 lg:px-12">
        <div className="max-w-[1400px] mx-auto">
          {loading ? (
            ...
            <div className="text-center py-20">
              <p className="font-bold text-white/60">No news found</p>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredNews.map((item) => (
                <div
                  key={item.id}
                  className="group bg-white/5 border border-white/10 rounded-2xl overflow-hidden hover:bg-white/10 hover:border-[#00D9FF]/50 transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl hover:shadow-[#00D9FF]/20"
                >
                  ...
                  <div className="p-8">
                    <div className="flex items-center space-x-2 font-bold text-xs text-[#00D9FF] mb-4 uppercase tracking-wider">
                    ...
                    <h3 className="font-black text-2xl text-white mb-4 leading-tight group-hover:text-[#00D9FF] transition-colors duration-200">
                      {item.title}
                    </h3>
                    <p className="font-medium text-sm text-white/60 line-clamp-3 leading-relaxed">
                      {item.content}
                    </p>
                  </div>
                </div>
